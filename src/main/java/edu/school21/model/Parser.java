...
import static edu.school21.model.OperationsHelper.isBinaryOperation;
import static edu.school21.model.OperationsHelper.isUnaryOperation;
...
public class Parser {
    ...
    int shiftOperation(final String op) {
        ...
        if (Objects.equals(op, "ln") || Objects.equals(op, "mod")) {
            result = 2;
        } else if (Objects.equals(op, "sin") || Objects.equals(op, "cos") || Objects.equals(op, "log") || Objects.equals(op, "tan")
        ) {
            result = 3;
        } else if (Objects.equals(op, "sqrt") || Objects.equals(op, "atan") || Objects.equals(op, "acos") || Objects.equals(op, "asin")) {
            result = 4;
        }
        return result;
    }

...
public class BasicCalcModelTest {
  ...
  public void cos() {
    ...
    Assertions.assertEquals(round(Math.cos(Math.cos(1) + Math.cos(3))),
  ...
  public void sin() {
    ...
    Assertions.assertEquals(round(Math.sin(Math.sin(1) + Math.sin(3))),
  ...
  public void tan() {
    ...
    Assertions.assertEquals(round(Math.tan(Math.tan(1) + Math.tan(3))),
  ...
  public void atan() {
    ...
    Assertions.assertEquals(round(Math.atan(1) + Math.atan(3)),
        calc.getResult("atan(1)+atan(3)", 0));
    Assertions.assertEquals(round(Math.atan(Math.atan(1) + Math.atan(3))),
  ...
  public void square() {
    ...
    Assertions.assertEquals(round(Math.sqrt(1) + Math.sqrt(3)),
        calc.getResult("sqrt(1)+sqrt(3)", 0));
    Assertions.assertEquals(round(Math.sqrt(Math.sqrt(1) + Math.sqrt(3))),
  ...
  public void replaceX() {
    ...
    Assertions.assertEquals(round(3 * 3 * 3), calc.getResult("xxx", 3));
  }
